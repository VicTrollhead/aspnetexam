        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TestId = table.Column<int>(type: "int", nullable: false),
                    CountCorrectAnswers = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "18eb5370-bde0-440a-8763-71fe1d7ec8b8", "Admin", "ADMIN" },
                    { 2, "500c69ca-5bb7-4ac0-9dc3-559d139d9a42", "Teacher", "TEACHER" },
                    { 3, "0d53864e-98b0-47f7-b4a7-a8ca17885319", "Student", "STUDENT" },
                    { 4, "4fbedda1-51d8-4455-8e27-740c7d2a0cda", "Guest", "GUEST" }
                });
